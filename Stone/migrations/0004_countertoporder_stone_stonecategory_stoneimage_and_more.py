    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "length",
                    models.DecimalField(
                        decimal_places=2, max_digits=6, verbose_name="Длина (м)"
                    ),
                ),
                (
                    "width",
                    models.DecimalField(
                        decimal_places=2, max_digits=6, verbose_name="Ширина (м)"
                    ),
                ),
                (
                    "thickness",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(max_length=200, verbose_name="Название камня"),
                ),
                ...
                (
                    "main_image",
                    models.ImageField(upload_to="stones/", verbose_name="Главное фото"),
                ),
                (
                    "price_per_sqm",
                    models.DecimalField(
                        decimal_places=2, max_digits=10, verbose_name="Цена за м²"
                    ),
                ),
                (
                    "hardness",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image",
                    models.ImageField(
                        upload_to="stones/gallery/", verbose_name="Изображение"
                    ),
                ),
